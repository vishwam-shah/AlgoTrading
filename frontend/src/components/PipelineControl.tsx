...
// Universe of record — must stay in sync with V3/00_config/tickers.py (100 NSE symbols).
const ALL_100 = [
  'SBIN','HDFCBANK','ICICIBANK','AXISBANK','KOTAKBANK','INDUSINDBK','BANDHANBNK','IDFCFIRSTB','FEDERALBNK','AUBANK','RBLBANK',
  'BAJFINANCE','BAJAJFINSV','HDFCLIFE','SBILIFE','ICICIGI','MUTHOOTFIN','CHOLAFIN','SHRIRAMFIN','MANAPPURAM','LICHSGFIN',
