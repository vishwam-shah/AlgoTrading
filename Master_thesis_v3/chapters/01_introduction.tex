...
Model committee           & 4 (XGB, LSTM, GRU, Ridge-stack)                            & 10 (LGBM, XGB, LSTM, BiLSTM, GRU, CNN-LSTM, CNN-GRU, TCN-GRU, TCN-Transformer, N-BEATS) \\
...
Reported headline         & 68.28\% direction acc (single split)                       & 51.45\% all-days; 60.33\% on 1{,}495 high-confidence signals (bootstrap CI $[57.99, 62.81]$) \\
