"""
================================================================================
CATBOOST CLASSIFIER - Categorical Boosting for Direction Prediction
================================================================================
...
- Often best for small datasets

Expected Performance: 57-63% accuracy
...
class CatBoostClassifier(BaseMLModel):
    """
    CatBoost binary classifier for stock direction prediction.

    Hyperparameters are optimized for:
    - Robust overfitting prevention
    - Handling small/noisy datasets
    - Fast inference
    """
    ...
    def __init__(
        ...
        Args:
            ...
            l2_leaf_reg: L2 regularization (CatBoost specific)
    ...
    def train(
        ...
        try:
            from catboost import CatBoostClassifier as CBClassifier, Pool

            # Initialize model
            self.model = CBClassifier(
            ...
            if hasattr(self.model, 'get_best_iteration'):
                ...
                logger.info(f"  Best iteration: {best_iter}/{self.iterations}")
            else:
    ...
    def predict(self, X: np.ndarray) -> np.ndarray:
        ...
        # CatBoost returns 1D array, ensure it's int
...
if __name__ == '__main__':
    ...
    model = CatBoostClassifier(
        iterations=100,  # Fewer for testing
        depth=3,
        learning_rate=0.1,
    ...
    print("\n[SUCCESS] CatBoost Classifier working correctly!")
